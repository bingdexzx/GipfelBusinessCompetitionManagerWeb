...
class Stock(models.Model):
    ...
    total_shares = ExactDecimalField(max_digits=60, decimal_places=4)
    init_net_profit = ExactDecimalField(max_digits=60, decimal_places=4)
    ...
    init_price = ExactDecimalField(max_digits=60, decimal_places=4)
    current_price = ExactDecimalField(max_digits=60, decimal_places=4)
...
class StockFundsAccount(models.Model):
    ...
    cash_balance = ExactDecimalField(max_digits=60, decimal_places=4, default=1_000_000)
...
class StockHolding(models.Model):
    ...
    shares = ExactDecimalField(max_digits=60, decimal_places=4, default=0)
    cost_price = ExactDecimalField(max_digits=60, decimal_places=4)
    competition = models.ForeignKey(
        "competitions.Competition",
        on_delete=models.CASCADE,
...
class StockOrder(models.Model):
    ...
    quantity = ExactDecimalField(max_digits=60, decimal_places=4)
    amount = ExactDecimalField(max_digits=60, decimal_places=4)
...
class StockCandle(models.Model):
    ...
    open = ExactDecimalField(max_digits=60, decimal_places=4)
    high = ExactDecimalField(max_digits=60, decimal_places=4)
    low = ExactDecimalField(max_digits=60, decimal_places=4)
    close = ExactDecimalField(max_digits=60, decimal_places=4)
    change_pct = ExactDecimalField(max_digits=60, decimal_places=4)
    # 成交量：本轮实际成交的股票数量
    volume = ExactDecimalField(max_digits=60, decimal_places=4, default=0)
    competition = models.ForeignKey(
        "competitions.Competition",
        on_delete=models.CASCADE,
