...
class StockSerializer(serializers.Serializer):
    ...
    # DRF DecimalField 默认 max_digits=60 decimal_places=2；显式声明以避免歧义。
    totalShares = serializers.DecimalField(max_digits=60, decimal_places=4, min_value=Decimal("0"))
    initNetProfit = serializers.DecimalField(max_digits=60, decimal_places=4, min_value=Decimal("0"))
    ...
    initPrice = serializers.DecimalField(max_digits=60, decimal_places=4, read_only=True)
    currentPrice = serializers.DecimalField(max_digits=60, decimal_places=4, read_only=True)
...
class StockFundsAccountSerializer(serializers.Serializer):
    ...
    cashBalance = serializers.DecimalField(
        max_digits=60, decimal_places=4, min_value=Decimal("0"), required=False
    )
