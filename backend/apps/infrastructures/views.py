...
权限：view=data:infrastructure:view，edit=data:infrastructure:edit。
路由由 backend.urls 以 path("api/", include("apps.infrastructures.urls")) 引入。
"""
...
class _CrudBase:
    ...
    view_permission = "data:infrastructure:view"
    edit_permission = "data:infrastructure:edit"
